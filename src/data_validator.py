...
class DataQualityValidator:
    ...
    def validate_referential_integrity(
        ...
        """
        results = {"patients_valid": True, "orphaned_records": {}, "issues": []}
    ...
    def _calculate_quality_score(
        self, patient_results: Dict, condition_results: Dict, medication_results: Dict
    ) -> float:
        """
        ...
        for field in ["ConditionID", "PatientID"]:
            if field in condition_results.get("completeness", {}):
                completeness = (
                    100 - condition_results["completeness"][field]["missing_percentage"]
                )
                scores.append(completeness)
        ...
        for field in ["MedicationID", "PatientID"]:
            if field in medication_results.get("completeness", {}):
                completeness = (
                    100
                    - medication_results["completeness"][field]["missing_percentage"]
                )
                scores.append(completeness)
